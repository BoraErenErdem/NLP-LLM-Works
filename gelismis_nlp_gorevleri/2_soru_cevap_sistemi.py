...
def predict_answer(context, question): # context -> metin # question -> soru
    ...
    # ._encode_plus() -> metni modele uygun hale getiren fonksiyon
    input_ids = encoding['input_ids'] # input_ids -> her kelimeye karşılık gelen token_id'ler
    attention_mask = encoding['attention_mask'] # attention_mask -> hangi tokenların dikkate alınacağını belirler
